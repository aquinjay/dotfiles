...
local function lsp_highlight_document(client) -- highlight over the word and other instances of the word (except keywords)
...
local function lsp_keymaps(bufnr) --lsp_keymaps
...
M.on_attach = function(client, bufnr) 
  if client.name == "tsserver" then -- if tsserver is being used, turn off document formatting.
